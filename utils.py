...
class CIFAR100C(datasets.VisionDataset):
    def __init__(self, root: str, name: str, transform=None, target_transform=None):
        super(CIFAR100C, self).__init__(root, transform=transform, target_transform=target_transform)
        data_path = os.path.join(root, name + ".npy")
        target_path = os.path.join(root, "labels.npy")
...
class TinyImageNetC(datasets.VisionDataset):
    def __init__(self, root: str, name: str, transform=None, target_transform=None):
        super(TinyImageNetC, self).__init__(root, transform=transform, target_transform=target_transform)
        data_path = os.path.join(root, name + ".npy")
        target_path = os.path.join(root, "labels.npy")
